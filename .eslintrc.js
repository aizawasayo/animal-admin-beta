module.exports = {
  ...
  rules: {
    ...
    'space-before-function-paren': ['off', { anonymous: 'never', named: 'never', asyncArrow: 'always' }], // 在具名函数/和匿名函数名(function)后面不要留空格
    ...
    // 'prettier/prettier': [
    //   'warn',
    //   { singleQuote: true, semi: false, bracketSpacing: true, jsxSingleQuote: false, jsxBracketSameLine: true }
    // ]
