<template>
  <div class="app-container">
    <el-row class="search-box" type="flex" justify="space-between">
      <el-col :span="16">
        <el-row :gutter="24">
          ...
          <el-col :span="8">
            <el-button type="primary" @click="() => commonApi.openAddForm('fish', this)">添加鱼类</el-button>
          </el-col>
        </el-row>
      </el-col>
    ...
    <el-dialog
      ...
      @close="() => commonApi.dialogAddClose('fish', this)"
    >
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="场所" prop="locale">
              <el-select v-model="newFish.locale" multiple placeholder="请选择出现场所">
                <el-option v-for="item in localeList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="鱼影" prop="shadow">
              <el-select v-model="newFish.shadow" placeholder="请选择鱼影大小">
                <el-option v-for="item in shadowList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="9">
            <el-form-item label="北半球" prop="activeTime.north">
              <el-select
                ...
                "
              >
                <el-option v-for="item in monthList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="9">
            <el-form-item label="结束时间" prop="periodEnd">
              <el-time-select v-model="newFish.periodEnd" :picker-options="periodOptions" placeholder="请选择结束时间">
              </el-time-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="解锁要求" prop="unlockCondition">
              <el-select v-model="newFish.unlockCondition" placeholder="请选择解锁条件">
                <el-option v-for="item in unlockConditionList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="稀有度" prop="rarity">
              <el-select v-model="newFish.rarity" placeholder="请选择稀有程度">
                <el-option v-for="item in rarityList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    postFish() {
      const startPeriod =
        this.newFish.periodStart.indexOf('0') === 0
          ? this.newFish.periodStart.substring(1, 2)
          : this.newFish.periodStart.substring(0, 2)
      const endPeriod =
        this.newFish.periodEnd.indexOf('0') === 0
          ? this.newFish.periodEnd.substring(1, 2)
          : this.newFish.periodEnd.substring(0, 2)
