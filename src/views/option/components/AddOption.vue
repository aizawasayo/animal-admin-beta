        ...
        <el-col :span="8">
          <el-form-item label="类型" prop="type">
            <el-select v-model="newOption.type" collapse-tags placeholder="请选择选项类型">
              <el-option v-for="(item, i) in tabOptions" :key="item.key + i" :label="item.label" :value="item.key">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col v-show="isActivity" :span="8">
          <el-form-item label="位置" prop="position">
            <el-select v-model="newOption.position" multiple collapse-tags placeholder="请选择所属半球">
              <el-option v-for="(item, i) in positionList" :key="item.key + i" :label="item.label" :value="item.key">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
