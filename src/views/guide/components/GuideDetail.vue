        ...
        <el-row>
          <el-col :span="24">
            ...
            <div class="postInfo-container">
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="60px" label="作者:" class="postInfo-container-item" prop="author" required>
                    <el-select
                      ...
                      placeholder="搜索作者"
                    >
                      <el-option v-for="item in userListOptions" :key="item._id" :label="item.username" :value="item" />
                    </el-select>
                  </el-form-item>
                </el-col>
                ...
                <el-col :span="6">
                  <el-form-item label-width="90px" label="分类:" class="postInfo-container-item" prop="type" required>
