          ...
          <el-col :span="8">
            <el-form-item label="改造类型" prop="remould">
              <el-select v-model="newFurniture.remould" placeholder="请选择改造类型">
                <el-option v-for="item in remouldList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="8">
            <el-form-item label="所属系列" prop="series">
              <el-select v-model="newFurniture.series" placeholder="请选择所属系列">
                <el-option v-for="item in seriesList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
