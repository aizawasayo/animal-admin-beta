    ...
    >
      ...
      <el-table-column label="颜色" align="center" prop="color" column-key="color" :filters="colorList">
        <template slot-scope="scope">
          ...
          <!-- span v-for="(item, index) in scope.row.color" :key="'color' + index">{{ index === scope.row.color.length - 1 ? item : item + '、' }}</span -->
        </template>
      </el-table-column>
      <el-table-column
        label="风格"
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="类型" prop="type" required>
              <el-select v-model="newClothing.type" collapse-tags placeholder="请选择种类">
          ...
          <el-col :span="8">
            <el-form-item label="颜色" prop="color">
              <el-select v-model="newClothing.color" multiple collapse-tags placeholder="请选择颜色">
                <el-option v-for="item in colorList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="风格" prop="style">
              <el-select v-model="newClothing.style" multiple collapse-tags placeholder="请选择风格">
                <el-option v-for="item in styleList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="主题" prop="theme">
              <el-select v-model="newClothing.theme" multiple collapse-tags placeholder="请选择主题">
                <el-option v-for="item in themeList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="订购类型" prop="orderType">
              <el-select v-model="newClothing.orderType" placeholder="请选择订购类型">
                <el-option v-for="item in orderTypeList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="来源(多选)" prop="channels">
              <el-select v-model="newClothing.channels" multiple collapse-tags placeholder="请选择获取途径">
                <el-option v-for="item in channelList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col v-show="isSale" :span="8">
            <el-form-item label="售卖时间" prop="saleTime">
              <el-select v-model="newClothing.saleTime" placeholder="请选择售卖时间">
                <el-option v-for="item in seasonList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="所属活动" prop="activity">
              <el-select v-model="newClothing.activity" placeholder="请选择所属活动">
                <el-option v-for="item in activityList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="24">
            <el-form-item label="途径说明" prop="channelDetail">
              <el-input v-model="newClothing.channelDetail" type="textarea" placeholder="请输入具体途径说明" />
            </el-form-item>
          </el-col>
