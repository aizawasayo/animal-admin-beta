  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="联系方式" align="center">
        <template slot-scope="scope">
          {{ scope.row.contactDetail ? scope.row.contact + ':' + scope.row.contactDetail : '' }}
        </template>
      </el-table-column>
      <el-table-column label="有效时间" align="center">
        <template slot-scope="scope">
          {{ scope.row.validTime | parseTime('{y}-{m}-{d} {h}:{i}') }}
        </template>
      </el-table-column>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="菜价" prop="price" required>
              <el-input v-model.number="newTurnip.price" placeholder="请输入大头菜报价" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
  ...
  data() {
    return {
      ...
      newTurnipRules: {
        ...
        exchangeType: [{ required: true, message: '请选择交易类型', trigger: 'change' }]
      },
      multipleSelection: []
    }
  },
