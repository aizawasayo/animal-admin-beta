<template>
  <div class="app-container">
    <el-row class="search-box" type="flex" justify="space-between">
      <el-col :span="16">
        <el-row :gutter="24">
          ...
          <el-col :span="8">
            <el-button type="primary" @click="() => commonApi.openAddForm('board', this)">添加</el-button>
          </el-col>
        </el-row>
      </el-col>
    ...
    <el-dialog
      ...
      @close="() => commonApi.dialogAddClose('board', this)"
    >
          ...
          <el-col :span="8">
            <el-form-item label="话题" prop="topic">
              <el-select v-model="newBoard.topic" collapse-tags placeholder="请选择话题">
                <el-option v-for="item in topicList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
